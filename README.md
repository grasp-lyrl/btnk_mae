...
- [Examples](#examples)
  ...
  - [Compress and reconstruct images from ImageNet-1k (224x224)](#compress-and-reconstruct-images-from-imagenet-1k-224x224)
  - [Processing Panorama Images](#processing-panorama-images)
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/grasp-lyrl/btnk_mae/blob/main/examples/demo.ipynb)
...
|-------|--------------|-----------------------|--------------------------------|----------|
| btnk_mae_vit_base_224.pth | ViT-Base | None | 1000 | [Hugging Face](https://huggingface.co/zhaozewang56/btnk_mae/blob/main/btnk_mae_vit_base_224.pth) |
| btnk_mae_vit_large_relu_224.pth | ViT-Large | ReLU | 200 | [Hugging Face](https://huggingface.co/zhaozewang56/btnk_mae/blob/main/btnk_mae_vit_large_relu_224.pth) |
